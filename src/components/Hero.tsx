...
export function Hero() {
  return (
    <section id="book" className="section-padding relative pt-36 md:pt-44 min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container-wide relative z-10 flex items-center">
        <FadeIn direction="left" delay={150}>
          <div className="max-w-xl">
            <span className="label-tag">Premium mobility in Bayelsa</span>
            <h1 className="mt-6 text-3xl sm:text-4xl font-extrabold leading-[1.08] tracking-tight text-white dark:text-ink md:text-5xl lg:text-[3.5rem]">
              Your city ride,{' '}
              <span className="text-brand-light dark:text-brand">elevated</span> from pickup to arrival
            </h1>
            <p className="mt-6 text-lg leading-relaxed text-slate-200 dark:text-ink-muted">
            ...
            <div className="mt-12 flex items-center gap-6">
              ...
              <p className="text-sm text-slate-300 dark:text-ink-muted">
