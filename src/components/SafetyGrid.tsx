...
export function SafetyGrid() {
  return (
    <section id="safety" className="section-padding safety-section-bg overflow-hidden">
      <div className="container-wide">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-6 md:grid-rows-2">
          <FadeIn direction="up" delay={100} duration={650} className="md:col-span-3 md:row-span-2">
            <article className="card-premium flex flex-col justify-between p-8 md:p-10 h-full">
              <div>
          ...
          {features.slice(1).map((feature, index) => (
            <FadeIn key={feature.title} direction="up" delay={150 + index * 90} duration={600} className="md:col-span-3">
