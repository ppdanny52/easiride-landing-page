...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-surface-elevated text-ink overflow-hidden">
          ...
          <FadeIn direction="up" delay={150}>
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <form onSubmit={handleSubmit} className="mt-6 w-full max-w-md">
                ...
                {subscribed && (
                  <p className="mt-3 text-xs font-semibold text-emerald-500 animate-fadeIn text-center sm:text-left">
