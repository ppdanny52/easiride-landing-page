...
export function DriverPartner() {
  return (
    <section id="drive" className="section-padding bg-slate-950 text-white overflow-hidden">
      <div className="container-wide grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2">
              {benefits.map((benefit, index) => (
                <FadeIn key={benefit.title} direction="up" delay={100 + index * 70} duration={550}>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5 transition-transform duration-300 hover:scale-[1.02] hover:bg-white/10">
        ...
        <FadeIn direction="up" delay={200} scale>
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 rounded-2xl bg-brand px-5 py-3 text-sm font-semibold text-white shadow-xl animate-bounce" style={{ animationDuration: '3s' }}>
