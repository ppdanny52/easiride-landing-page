  ...
  return (
    <section id="download" className="section-padding pb-28">
      <div className="container-wide">
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-brand via-brand-light to-brand-dark px-8 pt-16 pb-20 text-white md:px-16 md:pt-20 md:pb-28">
          ...
          <div className="relative grid items-center gap-10 md:grid-cols-2 md:items-start md:gap-8 lg:grid-cols-[47fr_53fr] lg:items-center lg:gap-12">
            ...
            <div className="flex justify-center md:justify-end lg:min-w-0 lg:self-center">
              <img
                ...
                width="620"
                height="1270"
                className="h-auto w-[90%] max-w-[620px] object-contain drop-shadow-[0_20px_40px_rgba(0,0,0,0.35)] animate-float-phone md:w-full md:max-w-[min(100%,620px)]"
              />
            </div>
          </div>
        </div>
